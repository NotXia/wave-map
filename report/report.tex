...
Per tale motivo, può capitare che una misurazione del Wi-Fi sia in grado di ottenere solo informazioni riguardanti la rete attualmente connessa.
...
I file in cui vengono esportate le misurazioni vengono riconosciuti dall'\texttt{intent-filter} attraverso l'estensione. Ciò però non è sempre possibile qualora il file sia salvato in un'altra applicazione che salva i propri contenuti con un nome alternativo.
