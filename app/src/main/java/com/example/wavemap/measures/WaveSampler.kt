...
abstract class WaveSampler {
     ...
     * */
    abstract suspend fun retrieve(top_left_corner: LatLng, bottom_right_corner: LatLng, limit: Int?=null, get_shared: Boolean=true) : List<WaveMeasure>
     ...
     * @param limit                     Number of past measurements to consider (all by default)
     * */
    suspend fun average(top_left_corner: LatLng, bottom_right_corner: LatLng, limit: Int?=null, get_shared: Boolean=true) : Double? {
        val measurers = retrieve(top_left_corner, bottom_right_corner, limit, get_shared)
