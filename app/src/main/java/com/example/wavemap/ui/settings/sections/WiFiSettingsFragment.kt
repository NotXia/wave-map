...
class WiFiSettingsFragment : PreferenceFragmentCompat() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val range_bad = preferenceManager.findPreference<EditTextPreference>("wifi_range_bad")
        val range_good = preferenceManager.findPreference<EditTextPreference>("wifi_range_good")
        val past_limit = preferenceManager.findPreference<EditTextPreference>("wifi_past_limit")
        ...
        range_bad?.summaryProvider = Preference.SummaryProvider<EditTextPreference> { preference -> "${ preference.text ?: getString(R.string.wifi_default_range_bad) } dBm" }
        ...
        range_good?.summaryProvider = Preference.SummaryProvider<EditTextPreference> { preference -> "${ preference.text ?: getString(R.string.wifi_default_range_good) } dBm" }
